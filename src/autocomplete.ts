...
export class Autocomplete<T extends AutocompleteSuggestion> {
  ...
  private setupEventListeners(): void {
    ...
    while (parent) {
      parent.addEventListener("scroll", this.handlePositionUpdate.bind(this), { passive: true });
      parent = parent.parentElement;
    }  
    window.addEventListener("scroll", this.handlePositionUpdate.bind(this), { passive: true });
  ...
  public destroy(): void {
    ...
    let parent = this.options.inputElement.parentElement;
    while (parent) {
      parent.removeEventListener("scroll", this.handlePositionUpdate.bind(this));
      parent = parent.parentElement;
    }
